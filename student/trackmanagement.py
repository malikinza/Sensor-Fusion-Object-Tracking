...
class Track:
    ...
    def __init__(self, meas, id):
        ...
        sens_coord = np.ones((4,1)) #homogenous coordinates
        sens_coord[0:3] = meas.z[0:3] #[z1, z2, z3,1]
        veh_coord = meas.sensor.sens_to_veh * sens_coord #position in vehicle coordinates

        self.x = np.zeros((6,1))
        self.x[0:3] = veh_coord[0:3] #6x1 vector with position and velocity
...
class Trackmanagement:
    ...
    def handle_updated_track(self, track):      
        ...
        ############
        track.score += 1/params.window
        track.score = min(track.score, 1) #max track score is 1, which are confirmed 'true positive' tracks.
