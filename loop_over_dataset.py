...
results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results/lidar_detections') #'results/fpn-resnet/results_sequence_2_resnet'
datafile = WaymoDataFileReader(data_fullpath)
datafile_iter = iter(datafile)  # initialize dataset iterator

## Initialize object detection
configs_det = det.load_configs(model_name='fpn-resnet') # options are 'darknet', 'fpn-resnet'
